<template>
  <section class="py-16 max-sm:relative max-sm:!bottom-[-1100px] ">
    <div class="container px-4 mx-auto">
      <div class="flex flex-col items-center gap-12 lg:flex-row">
        <!-- Text Content -->
        <div 
          ref="textContent"
          class="relative transition-all duration-500 ease-out lg:w-1/2 top-10"
          :class="{
            'opacity-0 translate-y-30': !textVisible,
            'animate-fadeInUp': textVisible
          }"
        >
          <h1 class="relative text-4xl font-bold text-gray-800 bottom-15 max-sm:bottom-8 max-sm:!text-3xl">"Découvrez comment nous façonnons les leaders de demain"</h1>
          <p class="text-[18px] max-sm:!text-base text-gray-600 bottom-30 mt-0 mb-4 block [margin-block-start:1em] [margin-block-end:1em] [margin-inline-start:0] [margin-inline-end:0] [unicode-bidi:isolate]">
          ...
          <div class="flex flex-col items-center gap-4 mt-8 max-sm:relative max-sm:right-20 sm:flex-row">
            <a 
              href="/about" 
              class="inline-block bg-[#FE5D37] hover:bg-[#ff6c4b] text-white max-sm:!text-base  font-medium rounded-full py-4 px-10 transition-colors"
            >
              Plus d'informations
            </a>
            <div class="flex items-center gap-3 ml-8">
              ...
              <div>
                <p class="font-medium text-[#FE5D37]">Bahaeddine Kacem</p>
        ...
        <div 
          ref="imageGallery"
          class="grid grid-cols-2 gap-4 lg:w-1/2"
          :class="{
        ...
        >
          <div @click="setActive1" 
            class="flex justify-center col-span-2 transition-all duration-500 ease-out max-sm:mt-8"
          >
